...
DEFINE connect_string     = 'bu26yxgq.cab6zez7ja5b.us-west-2.rds.amazonaws.com:1521/ORCL'
PROMPT
...
connect &&sys_user/&&password_system@&&connect_string
...
@/home/c754user/demo/human_resources/hr_main.sql &&password_hr &&default_ts &&temp_ts &&password_sys &&logfile_dir &&connect_string

connect &&sys_user/&&password_system@&&connect_string
SET SHOWMODE OFF

@/home/c754user/demo/order_entry/oe_main.sql &&password_oe &&default_ts &&temp_ts &&password_hr &&password_sys /home/c754user/demo/order_entry/ &&logfile_dir &vrs &&connect_string

connect &&sys_user/&&password_system@&&connect_string

SET SHOWMODE OFF

@/home/c754user/demo/product_media/pm_main.sql &&password_pm &&default_ts &&temp_ts &&password_oe &&password_sys /home/c754user/demo/product_media/ &&logfile_dir /home/c754user/demo/product_media/ &&connect_string

connect &&sys_user/&&password_system@&&connect_string
SET SHOWMODE OFF

@/home/c754user/demo/info_exchange/ix_main.sql &&password_ix &&default_ts &&temp_ts &&password_sys &&logfile_dir &vrs &&connect_string

connect &&sys_user/&&password_system@&&connect_string
SET SHOWMODE OFF

@/home/c754user/demo/sales_history/sh_main &&password_sh &&default_ts &&temp_ts &&password_sys /home/c754user/demo/sales_history/ &&logfile_dir &vrs &&connect_string

connect &&sys_user/&&password_system@&&connect_string
SET SHOWMODE OFF

@/home/c754user/demo/bus_intelligence/bi_main &&password_bi &&default_ts &&temp_ts &&password_sys &&password_oe &&password_sh &&logfile_dir &vrs &&connect_string
...
@/home/c754user/demo/mkverify &&password_system &veri_spool &&connect_string
