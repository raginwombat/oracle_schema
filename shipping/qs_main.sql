...
connect &&sys_user/&pass_sys@&connect_string AS SYSDBA;
GRANT execute ON sys.dbms_stats TO qs_adm;
GRANT execute ON dbms_lock to qs_adm;

connect &&sys_user/&master_pass@&connect_string
